  ...
  return (
    <section className="bg-black py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-[10px] font-mono font-bold tracking-[0.4em] text-slate-300 uppercase">
        ...
        >
          ...
          <div className="flex flex-col gap-10">
            <h3 className="font-display text-2xl md:text-4xl text-slate-200 font-light leading-tight">
              TripleDefence transforms CRA compliance from:
            </h3>
            
            <div className="space-y-4">
              <p className="font-display text-3xl md:text-5xl lg:text-6xl font-bold italic text-slate-500 line-through decoration-neon-red/40 decoration-2">
                "Detect and report exploitation under <span className="text-slate-400 line-through decoration-neon-red/60">uncertainty</span>"
              </p>
        ...
        >
          <p className="text-lg md:text-xl text-slate-200 font-normal leading-relaxed drop-shadow-sm">
            This is the strongest regulatory position any manufacturer can take. We move you from reactive reporting to <span className="text-white font-bold">architectural sovereignty</span>.
          </p>
        </motion.div>
      </div>
    </section>
