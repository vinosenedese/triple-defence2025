      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Unidirectional Flow Visual */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-4/5 h-4/5 border border-white/5 rounded-full bg-neon-purple/5 backdrop-blur-3xl overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-8">
                  ...
                  <p className="text-neon-purple/70 font-mono text-[10px] tracking-[0.2em] uppercase font-bold">Unidirectional Integrity</p>
                </div>

                {/* Status Indicator */}
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-3 px-4 py-2 bg-black/80 border border-white/10 rounded-full">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                  <span className="font-mono text-[10px] text-white tracking-widest uppercase">Input: Blocked | Output: Enabled</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              ...
              <h2 className="font-display text-4xl md:text-6xl font-bold text-white mb-6 tracking-tighter leading-none">
                Sovereign Autonomous <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-purple to-indigo-400">Technology Operations</span>
              </h2>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 bg-[#050505] border border-white/10 rounded-xl hover:border-neon-purple/50 transition-all duration-500 group"
              >
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed mb-4 italic border-l-2 border-neon-purple/30 pl-4">
