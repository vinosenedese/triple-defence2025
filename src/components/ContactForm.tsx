...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-32 relative flex items-center justify-center bg-charcoal">
        ...
        >
            ...
            <div className="text-center mb-12">
                <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-4 tracking-tighter">
                    Secure Your <span className="text-neon-purple">Infrastructure</span>
                </h2>
